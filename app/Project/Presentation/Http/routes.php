...
Route::group(['middleware' => ['web', 'auth'], 'prefix' => 'my', 'namespace' => 'Project\Presentation\Http\Controller'], function() {
    ...
    Route::post('project/{project}/team', ['as' => 'project.project.store_invite', 'uses' => 'ProjectController@storeInvite']);
    Route::get('project/{project}/user/remove', ['as' => 'project.project.remove_me', 'uses' => 'ProjectController@removeMe']);
    Route::get('project/{project}/user/{user}/remove', ['as' => 'project.project.remove_user', 'uses' => 'ProjectController@removeUser']);
    Route::get('project/{project}/invite/{invite}/remove', ['as' => 'project.project.remove_invite', 'uses' => 'ProjectController@removeInvite']);
