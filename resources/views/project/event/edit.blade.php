...
@section('title', trans('app.title_edit_event'))

@section('header')
    {{ trans('app.title_edit_event') }}
@endsection
...
@section('content')
    ...
    <section class="flying">
        <div class="panel-s">
            ...
            {!! Form::model(
                ['name' => $event->name(), 'details' => $event->details(), 'day' => utc_date_formatted($event->occursOn(), $userDateFormat, $userTimezone), 'hour' => utc2local($event->occursOn(), 'H', $userTimezone), 'minute' => utc2local($event->occursOn(), 'i', $userTimezone)],
                ['route' => ['project.event.update', $selectedProjectId, $event->eventId()->id()], 'method' => 'patch', 'id' => 'discussion-form']
             ) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div>
                            {!! Form::select('hour', timepicker_hours($userTimeFormat), null, ['class' => 'form-control']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
            ...
            <div class="form-control-submit">
                <div class="row">
                    <div class="col-md-5">
                        ...
                        {!! Html::cancel(route('project.event.show', [$selectedProjectId, $event->eventId()->id()])) !!}
                    </div>
                </div>
            </div>
